...
from info import CHANNELS, ADMINS, AUTH_CHANNEL, LOG_CHANNEL, PICS, PICS2, BATCH_FILE_CAPTION, CUSTOM_FILE_CAPTION, PROTECT_CONTENT
...
FORCE_TEXT="""Please Join My Update Join Channel and Try again

🗣 မိတ်‌ဆွေကြည့်ချင်တဲ့ဇာတ်ကားကို ပို့ပေးဖိုအတွက် 
👉🏻 Join Channel 👈🏻ကို Join ထားဖိုလိုပါတယ်။ 
 Channel လေးကို  Join ပြီးရင် 
 👉 Try Again 👈 လေးကို နှိပ်လိုက်ပါ 
ပြီးရင် start ကိုနှိပ်လိုက်ရင် 👌 ရပါပြီး။ 
...
async def start(client, message):
        ...
        buttons = [
            [
                InlineKeyboardButton(
                    '🤖 Updates', url='https://t.me/MKSVIPLINK')
            ],
            [
                InlineKeyboardButton(
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton('♻️ JOIN OUR GROUP TO USE ME ♻️',
                                 url='https://t.me/MKS_REQUESTGROUP')
        ], [
            InlineKeyboardButton(
                '⚜️VIP SERIES ', url='https://t.me/Kpautoreply_bot'),
    ...
    if data.startswith("pquery"):
        return await auto_filter(client, message, data)
    try:
    ...
    await client.send_cached_media(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton("😎 Owner Acc 😎", url="https://t.me/KOPAINGLAY15")
                ]
            ]
